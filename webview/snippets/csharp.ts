...
<span data-token="punctuation">{</span>
    ...
    <span data-token="punctuation">{</span>
        ...
        <span data-token="class">Module</span><span data-token="operator">.</span><span data-token="functionAndMethod">WriteLine</span><span data-token="punctuation">(</span><span data-token="string">$"Result: X=</span><span data-token="punctuation">{</span><span data-token="variable">result</span><span data-token="operator">.</span><span data-token="property">X</span><span data-token="punctuation">}</span><span data-token="string">, Y=</span><span data-token="punctuation">{</span><span data-token="variable">result</span><span data-token="operator">.</span><span data-token="property">Y</span><span data-token="punctuation">}</span><span data-token="string">"</span><span data-token="punctuation">)</span><span data-token="punctuation">;</span>
    <span data-token="punctuation">}</span>
<span data-token="punctuation">}</span>
...
<span data-token="punctuation">{</span>
    ...
    <span data-token="punctuation">{</span>
        ...
        <span data-token="parameter">logger</span><span data-token="operator">.</span><span data-token="extensionMethod">GetTypeName</span><span data-token="punctuation">(</span><span data-token="punctuation">)</span><span data-token="punctuation">;</span>
        ...
        <span data-token="class">Module</span><span data-token="operator">.</span><span data-token="functionAndMethod">WriteLine</span><span data-token="punctuation">(</span><span data-token="string">"C:</span><span data-token="constant">\\\\</span><span data-token="string">Path</span><span data-token="constant">\\\\</span><span data-token="string">To</span><span data-token="constant">\\\\</span><span data-token="string">File.txt"</span><span data-token="punctuation">)</span><span data-token="punctuation">;</span>

        <span data-token="class">Module</span><span data-token="operator">.</span><span data-token="functionAndMethod">WriteLine</span><span data-token="punctuation">(</span><span data-token="variable">log</span><span data-token="punctuation">)</span><span data-token="punctuation">;</span>
        <span data-token="class">Module</span><span data-token="operator">.</span><span data-token="functionAndMethod">WriteLine</span><span data-token="punctuation">(</span><span data-token="variable">verbatim</span><span data-token="punctuation">)</span><span data-token="punctuation">;</span>
    <span data-token="punctuation">}</span>
