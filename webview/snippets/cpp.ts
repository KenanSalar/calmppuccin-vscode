...
<span data-token="type">void</span> <span data-token="extensionMethod">print_point</span><span data-token="punctuation">(</span><span data-token="keyword">const</span> <span data-token="namespace">MyApp</span><span data-token="operator">::</span><span data-token="type">Point</span> <span data-token="operator">&</span><span data-token="parameter">p</span><span data-token="punctuation">)</span> <span data-token="punctuation">{</span>
    <span data-token="namespace">std</span><span data-token="operator">::</span><span data-token="variable">cout</span> <span data-token="operatorOverload">&lt;&lt;</span> <span data-token="string">"Point(x: "</span> <span data-token="operatorOverload">&lt;&lt;</span> <span data-token="parameter">p</span><span data-token="operator">.</span><span data-token="property">x</span> <span data-token="operatorOverload">&lt;&lt;</span> <span data-token="string">", y: "</span> <span data-token="operatorOverload">&lt;&lt;</span> <span data-token="parameter">p</span><span data-token="operator">.</span><span data-token="property">y</span> <span data-token="operatorOverload">&lt;&lt;</span> <span data-token="string">")"</span> <span data-token="operatorOverload">&lt;&lt;</span> <span data-token="namespace">std</span><span data-token="operator">::</span><span data-token="functionAndMethod">endl</span><span data-token="punctuation">;</span>
<span data-token="punctuation">}</span>
