...
<span data-token="keyword">mod</span> <span data-token="module">core</span> <span data-token="punctuation">{</span>
    ...
    <span data-token="attributeBracket">#[</span><span data-token="decorator">derive</span><span data-token="punctuation">(</span><span data-token="class">Debug</span><span data-token="punctuation">,</span> <span data-token="class">Clone</span><span data-token="punctuation">,</span> <span data-token="class">Copy</span><span data-token="punctuation">)</span><span data-token="attributeBracket">]</span>
    ...
    <span data-token="keyword">impl</span> <span data-token="interface">Add</span> <span data-token="keyword">for</span> <span data-token="struct">Point</span> <span data-token="punctuation">{</span>
        ...
        <span data-token="keyword">fn</span> <span data-token="operatorOverload">add</span><span data-token="punctuation">(</span><span data-token="variable">self</span><span data-token="punctuation">,</span> <span data-token="parameter">other</span><span data-token="punctuation">:</span> <span data-token="keyword">Self</span><span data-token="punctuation">)</span> <span data-token="operator">-&gt;</span> <span data-token="keyword">Self</span> <span data-token="punctuation">{</span>
            <span data-token="keyword">Self</span> <span data-token="punctuation">{</span>
                <span data-token="property">x</span><span data-token="punctuation">:</span> <span data-token="variable">self</span><span data-token="punctuation">.</span><span data-token="property">x</span> <span data-token="operator">+</span> <span data-token="parameter">other</span><span data-token="punctuation">.</span><span data-token="property">x</span><span data-token="punctuation">,</span>
                <span data-token="property">y</span><span data-token="punctuation">:</span> <span data-token="variable">self</span><span data-token="punctuation">.</span><span data-token="property">y</span> <span data-token="operator">+</span> <span data-token="parameter">other</span><span data-token="punctuation">.</span><span data-token="property">y</span><span data-token="punctuation">,</span>
            <span data-token="punctuation">}</span>
        <span data-token="punctuation">}</span>
    <span data-token="punctuation">}</span>
    ...
    <span data-token="keyword">pub</span> <span data-token="keyword">struct</span> <span data-token="class">DataService</span><span data-token="punctuation">&lt;</span><span data-token="typeParameter">T</span><span data-token="punctuation">&gt;</span> <span data-token="punctuation">{</span>
        <span data-token="keyword">pub</span> <span data-token="property">name</span><span data-token="punctuation">:</span> <span data-token="type">String</span><span data-token="punctuation">,</span>
...
<span data-token="keyword">impl</span> <span data-token="module">core</span><span data-token="operator">::</span><span data-token="interface">IProcessable</span><span data-token="punctuation">&lt;</span><span data-token="type">String</span><span data-token="punctuation">&gt;</span> <span data-token="keyword">for</span> <span data-token="struct">MyProcessor</span> <span data-token="punctuation">{</span>
    <span data-token="keyword">fn</span> <span data-token="functionAndMethod">process</span><span data-token="punctuation">(</span><span data-token="operator">&</span><span data-token="keyword">mut</span> <span data-token="variable">self</span><span data-token="punctuation">,</span> <span data-token="parameter">data</span><span data-token="punctuation">:</span> <span data-token="type">String</span><span data-token="punctuation">)</span> <span data-token="punctuation">{</span>
        <span data-token="functionAndMethod">println!</span><span data-token="punctuation">(</span><span data-token="string">"Processing trait data: {}"</span><span data-token="punctuation">,</span> <span data-token="parameter">data</span><span data-token="punctuation">)</span><span data-token="punctuation">;</span>
    <span data-token="punctuation">}</span>
<span data-token="punctuation">}</span>

<span data-token="comment">// Bring the trait into scope so its methods can be used</span>
<span data-token="keyword">use</span> <span data-token="namespace">crate<span data-token="operator">::</span>core<span data-token="operator">::</span>IProcessable</span><span data-token="punctuation">;</span>
...
<span data-token="keyword">fn</span> <span data-token="functionAndMethod">main</span><span data-token="punctuation">(</span><span data-token="punctuation">)</span> <span data-token="punctuation">{</span>
    <span data-token="keyword">let</span> <span data-token="variable">p1</span> <span data-token="operator">=</span> <span data-token="module">core</span><span data-token="operator">::</span><span data-token="struct">Point</span> <span data-token="punctuation">{</span> <span data-token="property">x</span><span data-token="punctuation">:</span> <span data-token="number">10</span><span data-token="punctuation">,</span> <span data-token="property">y</span><span data-token="punctuation">:</span> <span data-token="number">20</span> <span data-token="punctuation">}</span><span data-token="punctuation">;</span>
    <span data-token="keyword">let</span> <span data-token="variable">p2</span> <span data-token="operator">=</span> <span data-token="module">core</span><span data-token="operator">::</span><span data-token="struct">Point</span> <span data-token="punctuation">{</span> <span data-token="property">x</span><span data-token="punctuation">:</span> <span data-token="number">5</span><span data-token="punctuation">,</span> <span data-token="property">y</span><span data-token="punctuation">:</span> <span data-token="number">8</span> <span data-token="punctuation">}</span><span data-token="punctuation">;</span>
    ...
    <span data-token="comment">// --- Usage examples to resolve all warnings ---</span>

    <span data-token="comment">// Create a list with both enum variants to ensure both are used</span>
    <span data-token="keyword">let</span> <span data-token="variable">statuses</span> <span data-token="operator">=</span> <span data-token="functionAndMethod">vec!</span><span data-token="punctuation">[</span>
        <span data-token="module">core</span><span data-token="operator">::</span><span data-token="enum">Status</span><span data-token="operator">::</span><span data-token="enumMember">Pending</span><span data-token="punctuation">,</span>
        <span data-token="module">core</span><span data-token="operator">::</span><span data-token="enum">Status</span><span data-token="operator">::</span><span data-token="enumMember">Completed</span> <span data-token="punctuation">{</span> <span data-token="property">time</span><span data-token="punctuation">:</span> <span data-token="number">12345</span> <span data-token="punctuation">}</span><span data-token="punctuation">,</span>
    ...
    <span data-token="keyword">for</span> <span data-token="variable">status</span> <span data-token="keyword">in</span> <span data-token="variable">statuses</span> <span data-token="punctuation">{</span>
        <span data-token="keyword">match</span> <span data-token="variable">status</span> <span data-token="punctuation">{</span>
            <span data-token="module">core</span><span data-token="operator">::</span><span data-token="enum">Status</span><span data-token="operator">::</span><span data-token="enumMember">Pending</span> <span data-token="operator">=&gt;</span> <span data-token="functionAndMethod">println!</span><span data-token="punctuation">(</span><span data-token="string">"Status: Pending"</span><span data-token="punctuation">)</span><span data-token="punctuation">,</span>
            <span data-token="module">core</span><span data-token="operator">::</span><span data-token="enum">Status</span><span data-token="operator">::</span><span data-token="enumMember">Completed</span> <span data-token="punctuation">{</span> <span data-token="parameter">time</span> <span data-token="punctuation">}</span> <span data-token="operator">=&gt;</span> <span data-token="punctuation">{</span>
                <span data-token="functionAndMethod">println!</span><span data-token="punctuation">(</span><span data-token="string">"Status: Completed at time {}"</span><span data-token="punctuation">,</span> <span data-token="parameter">time</span><span data-token="punctuation">)</span>
            <span data-token="punctuation">}</span>
        <span data-token="punctuation">}</span>
    <span data-token="punctuation">}</span>
    ...
    <span data-token="variable">processor</span><span data-token="punctuation">.</span><span data-token="functionAndMethod">process</span><span data-token="punctuation">(</span><span data-token="string">"test data"</span><span data-token="punctuation">.</span><span data-token="functionAndMethod">to_string</span><span data-token="punctuation">(</span><span data-token="punctuation">))</span><span data-token="punctuation">;</span>

    <span data-token="comment">// Construct DataService and use its methods and fields</span>
    <span data-token="keyword">let</span> <span data-token="variable">service</span> <span data-token="operator">=</span> <span data-token="module">core</span><span data-token="operator">::</span><span data-token="class">DataService</span> <span data-token="punctuation">{</span>
        <span data-token="property">name</span><span data-token="punctuation">:</span> <span data-token="string">"My Service"</span><span data-token="punctuation">.</span><span data-token="functionAndMethod">to_string</span><span data-token="punctuation">(</span><span data-token="punctuation">)</span><span data-token="punctuation">,</span>
        <span data-token="event">on_update</span><span data-token="punctuation">:</span> <span data-token="class">Box</span><span data-token="punctuation">.</span><span data-token="functionAndMethod">new</span><span data-token="punctuation">(</span><span data-token="operator">|</span><span data-token="parameter">message</span><span data-token="operator">|</span> <span data-token="functionAndMethod">println!</span><span data-token="punctuation">(</span><span data-token="string">"Update: {}"</span><span data-token="punctuation">,</span> <span data-token="parameter">message</span><span data-token="punctuation">))</span><span data-token="punctuation">,</span>
    <span data-token="punctuation">}</span><span data-token="punctuation">;</span>
    <span data-token="functionAndMethod">println!</span><span data-token="punctuation">(</span><span data-token="string">"Service Name: {}"</span><span data-token="punctuation">,</span> <span data-token="variable">service</span><span data-token="punctuation">.</span><span data-token="functionAndMethod">name</span><span data-token="punctuation">(</span><span data-token="punctuation">))</span><span data-token="punctuation">;</span>
    <span data-token="punctuation">(</span><span data-token="variable">service</span><span data-token="punctuation">.</span><span data-token="event">on_update</span><span data-token="punctuation">)(</span><span data-token="string">"Service was used."</span><span data-token="punctuation">.</span><span data-token="functionAndMethod">to_string</span><span data-token="punctuation">(</span><span data-token="punctuation">))</span><span data-token="punctuation">;</span>
<span data-token="punctuation">}</span>
`;
