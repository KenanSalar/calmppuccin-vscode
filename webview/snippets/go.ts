...
<span data-token="keyword">func</span> <span data-token="punctuation">(</span><span data-token="variable">p</span> <span data-token="struct">Point</span><span data-token="punctuation">)</span> <span data-token="functionAndMethod">Add</span><span data-token="punctuation">(</span><span data-token="parameter">other</span> <span data-token="struct">Point</span><span data-token="punctuation">)</span> <span data-token="struct">Point</span> <span data-token="punctuation">{</span>
    <span data-token="keyword">return</span> <span data-token="struct">Point</span><span data-token="punctuation">{</span><span data-token="variable">X</span><span data-token="punctuation">:</span> <span data-token="variable">p</span><span data-token="operator">.</span><span data-token="variable">X</span> <span data-token="operator">+</span> <span data-token="parameter">other</span><span data-token="operator">.</span><span data-token="variable">X</span><span data-token="punctuation">,</span> <span data-token="variable">Y</span><span data-token="punctuation">:</span> <span data-token="variable">p</span><span data-token="operator">.</span><span data-token="variable">Y</span> <span data-token="operator">+</span> <span data-token="parameter">other</span><span data-token="operator">.</span><span data-token="variable">Y</span><span data-token="punctuation">}</span>
<span data-token="punctuation">}</span>
...
<span data-token="keyword">func</span> <span data-token="functionAndMethod">main</span><span data-token="punctuation">(</span><span data-token="punctuation">)</span> <span data-token="punctuation">{</span>
    ...
    <span data-token="keyword">go</span> <span data-token="keyword">func</span><span data-token="punctuation">(</span><span data-token="punctuation">)</span> <span data-token="punctuation">{</span>
        <span data-token="keyword">for</span> <span data-token="variable">msg</span> <span data-token="operator">:=</span> <span data-token="keyword">range</span> <span data-token="variable">service</span><span data-token="operator">.</span><span data-token="event">UpdateEvent</span> <span data-token="punctuation">{</span>
            <span data-token="namespace">fmt</span><span data-token="operator">.</span><span data-token="functionAndMethod">Println</span><span data-token="punctuation">(</span><span data-token="string">"Event Received:"</span><span data-token="punctuation">,</span> <span data-token="variable">msg</span><span data-token="punctuation">)</span>
        <span data-token="punctuation">}</span>
    <span data-token="punctuation">}</span><span data-token="punctuation">(</span><span data-token="punctuation">)</span>

    <span data-token="variable">service</span><span data-token="operator">.</span><span data-token="event">UpdateEvent</span> <span data-token="operator">&lt;-</span> <span data-token="string">"Processing started"</span>
    ...
    <span data-token="variable">result</span> <span data-token="operator">:=</span> <span data-token="variable">p1</span><span data-token="operator">.</span><span data-token="functionAndMethod">Add</span><span data-token="punctuation">(</span><span data-token="variable">p2</span><span data-token="punctuation">)</span>

    <span data-token="namespace">fmt</span><span data-token="operator">.</span><span data-token="functionAndMethod">Printf</span><span data-token="punctuation">(</span><span data-token="string">\`Result: </span><span data-token="constant">%+v</span><span data-token="string">\`</span><span data-token="punctuation">,</span> <span data-token="variable">result</span><span data-token="punctuation">)</span>
    <span data-token="namespace">time</span><span data-token="operator">.</span><span data-token="functionAndMethod">Sleep</span><span data-token="punctuation">(</span><span data-token="number">100</span> <span data-token="operator">*</span> <span data-token="namespace">time</span><span data-token="operator">.</span><span data-token="constant">Millisecond</span><span data-token="punctuation">)</span>
<span data-token="punctuation">}</span>
`;
